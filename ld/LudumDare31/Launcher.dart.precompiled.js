...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|WebGLRenderingContext"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  TimerImpl: {
    "^": "Object;__isolate_helper$_once,_inEventLoop,_handle",
  ...
  _RectangleBase: {
    ...
    intersects$1: function(other) {
      ...
      if (t1 <= t2 + other.width) {
        ...
        if (t2 <= t1 + this.width) {
          ...
          if (typeof t1 !== "number")
            return t1.$le();
          t1 = t1 <= t2 + other.height && t2 <= t1 + this.height;
        } else
          t1 = false;
      } else
        t1 = false;
    ...
    containsRectangle$1: function(another) {
      ...
      if (t1 <= t2) {
        ...
        if (typeof t1 !== "number")
          return t1.$add();
        if (t1 + this.width >= t2 + another.width) {
          t1 = this.top;
          t2 = another.top;
          if (typeof t1 !== "number")
            return t1.$le();
          if (typeof t2 !== "number")
            return H.iae(t2);
          t1 = t1 <= t2 && t1 + this.height >= t2 + another.height;
        } else
          t1 = false;
      } else
        t1 = false;
...
["ld31", "Launcher.dart", , S, {
  "^": "",
  main: [function() {
    var game, t1, t2;
    game = new R.Game(0, null, null, null);
    game.Game$2(document.querySelector("#frame"), document.querySelector("#hud"));
    t1 = window;
    t2 = game.get$_loop();
...
1],
["ld31_bomb", "Bomb.dart", , F, {
  "^": "",
  Bomb: {
    "^": "Object;_ld31_bomb$_timer,_blowTime,_ld31_bomb$_x,_ld31_bomb$_y,_anim,_animIncrement,_ld31_bomb$_width,_ld31_bomb$_height,_radius,_blown,_done",
    tick$1: function(delta) {
      var t1, t2;
      t1 = this._ld31_bomb$_timer += delta;
      if (!this._blown && t1 > this._blowTime) {
        this._blow$0();
        this._blown = true;
        t1 = $.Sound_aexplosionSound.cloneNode(false);
        $.Sound_explosionSound = t1;
        J.play$0$x(t1);
      }
      t1 = this._blown;
      if (t1 && !this._done) {
        t2 = this._anim + this._animIncrement;
        this._anim = t2;
        if (t2 > this._radius)
          this._done = true;
      }
    ...
    _blow$0: function() {
      var enemies, t1, t2, r, i, t3, r2;
      enemies = $.EnemyManager__enemies;
      t1 = this._radius;
      t2 = t1 / 2;
      r = P.Rectangle$(this._ld31_bomb$_x - t2, this._ld31_bomb$_y - t2, this._ld31_bomb$_width + t1, this._ld31_bomb$_height + t1, null);
      if (enemies.length > 0)
        for (i = 0; i < enemies.length; ++i) {
          t1 = enemies[i];
          t2 = t1._ld31_enemy$_x;
          t3 = t1._ld31_enemy$_y;
          r2 = new P.Rectangle(t2, t3, t1._ld31_enemy$_width, t1._ld31_enemy$_height);
          r2.$builtinTypeInfo = [null];
          t1._ld31_enemy$_bounds = r2;
          if (r.intersects$1(r2)) {
            if (i >= enemies.length)
              return H.ioore(enemies, i);
            enemies[i]._ld31_enemy$_health = 0;
          }
        }
    },
    Bomb$2: function(x, y) {
      this._ld31_bomb$_x = x;
      this._ld31_bomb$_y = y;
      this._ld31_bomb$_timer = 0;
      this._blown = false;
      this._done = false;
    }
  }
}],
["ld31_bullet", "Bullet.dart", , R, {
  "^": "",
  Bullet: {
    "^": "Object;_ld31_bullet$_width,_ld31_bullet$_height,_ld31_bullet$_x,_ld31_bullet$_y,_ld31_bullet$_xSpeed,_ld31_bullet$_ySpeed,_ld31_bullet$_isFromPlayer",
    tick$1: function(delta) {
      var t1, t2;
      t1 = this._ld31_bullet$_x + this._ld31_bullet$_xSpeed;
      this._ld31_bullet$_x = t1;
      t2 = this._ld31_bullet$_y + this._ld31_bullet$_ySpeed;
      this._ld31_bullet$_y = t2;
      if (t1 < 0 || t1 > 800 || t2 < 0 || t2 > 600)
        return true;
      return false;
    },
    Bullet$4: function(x, y, angle, isFromPlayer) {
      this._ld31_bullet$_xSpeed = $.Bullet__speed * Math.cos(H.checkNum(angle));
      this._ld31_bullet$_ySpeed = $.Bullet__speed * Math.sin(H.checkNum(angle));
      this._ld31_bullet$_isFromPlayer = isFromPlayer;
      this._ld31_bullet$_x = x;
      this._ld31_bullet$_y = y;
    },
    static: {"^": "Bullet__speed"}
  }
}],
["ld31_enemy", "Enemy.dart", , S, {
  "^": "",
  Enemy: {
    "^": "Object;_ld31_enemy$_moveSpeed,_ld31_enemy$_maxSpeed,_ld31_enemy$_friction,_ld31_enemy$_x,_ld31_enemy$_y,_ld31_enemy$_width,_ld31_enemy$_height,_ld31_enemy$_xSpeed,_ld31_enemy$_ySpeed,_type,_ld31_enemy$_wave,_mainColor,_ld31_enemy$_health,_minAccuracy,_maxAccuracy,_ld31_enemy$_player,_ld31_enemy$_gun,_ld31_enemy$_timer,_waitTime,_ld31_enemy$_toIndex,_ld31_enemy$_pathVector,_ld31_enemy$_path,_ld31_enemy$_bounds",
    tick$1: function(delta) {
      var t1, t2, t3, t4, t5, t6, times;
      t1 = this._ld31_enemy$_timer;
      if (typeof t1 !== "number")
        return t1.$gt();
      if (t1 > this._waitTime) {
        t1 = this._ld31_enemy$_gun;
        t2 = this._ld31_enemy$_player;
        t2 = this._getAccuracy$1(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t2._ld31_entity_player$_x + t2._width / 2)));
        t3 = this._ld31_enemy$_player;
        t3 = this._getAccuracy$1(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3._ld31_entity_player$_y + t3._height / 2)));
        t4 = this._ld31_enemy$_x;
        t5 = this._ld31_enemy$_y;
        t6 = t1._ld31_gun$_timer += delta;
        if (!t1._canFire) {
          if (t6 >= t1._fireDelay)
            t1._canFire = true;
        } else {
          t1._fire$4(t2, t3, t4, t5);
          t1._canFire = false;
          t1._ld31_gun$_timer = 0;
        }
      } else
        this._ld31_enemy$_timer = t1 + delta;
      t1 = this._ld31_enemy$_path.moveAlongPath$3(this._ld31_enemy$_x, this._ld31_enemy$_y, this._ld31_enemy$_toIndex);
      this._ld31_enemy$_pathVector = t1;
      t2 = this._ld31_enemy$_moveSpeed * 4;
      t3 = t2 * t1._x;
      this._ld31_enemy$_xSpeed = t3;
      t2 *= t1._y;
      this._ld31_enemy$_ySpeed = t2;
      this._ld31_enemy$_toIndex = t1._z;
      if (t3 > 0) {
        t1 = t3 - this._ld31_enemy$_friction;
        this._ld31_enemy$_xSpeed = t1;
        if (t1 < 0) {
          this._ld31_enemy$_xSpeed = 0;
          t1 = 0;
        }
      } else if (t3 < 0) {
        t1 = t3 + this._ld31_enemy$_friction;
        ...
        t1 = t3;
      if (t2 > 0) {
        t2 -= this._ld31_enemy$_friction;
        this._ld31_enemy$_ySpeed = t2;
        if (t2 < 0) {
          this._ld31_enemy$_ySpeed = 0;
          t2 = 0;
        }
      } else if (t2 < 0) {
        t2 += this._ld31_enemy$_friction;
      ...
      t3 = this._ld31_enemy$_x;
      if (t3 + t1 < 0) {
        this._ld31_enemy$_x = 0;
        this._ld31_enemy$_xSpeed = 0;
        t1 = 0;
        t3 = 0;
      } else {
        t4 = this._ld31_enemy$_width;
        if (t3 + t4 + t1 >= 800) {
          t1 = 800 - t4 - 0;
          this._ld31_enemy$_x = t1;
          this._ld31_enemy$_xSpeed = 0;
          t3 = t1;
          t1 = 0;
        }
      }
      t4 = this._ld31_enemy$_y;
      if (t4 + t2 < 0) {
        this._ld31_enemy$_y = 0;
        this._ld31_enemy$_ySpeed = 0;
        t2 = 0;
        t4 = 0;
      } else {
        t5 = this._ld31_enemy$_height;
        if (t4 + t5 + t2 >= 600) {
          t2 = 600 - t5 - 0;
          this._ld31_enemy$_y = t2;
          this._ld31_enemy$_ySpeed = 0;
          t4 = t2;
          t2 = 0;
        }
      }
      this._ld31_enemy$_x = t3 + t1;
      this._ld31_enemy$_y = t4 + t2;
      times = U.Gun_collision(this.getBounds$0(), false);
      t2 = this._ld31_enemy$_health;
      if (typeof t2 !== "number")
        return t2.$sub();
      this._ld31_enemy$_health = t2 - times * 10;
      if (times > 0) {
        t1 = $.Sound_ahurtSound.cloneNode(false);
        $.Sound_hurtSound = t1;
        J.play$0$x(t1);
      }
      t1 = this._ld31_enemy$_health;
      if (typeof t1 !== "number")
        return t1.$le();
      if (t1 <= 0)
        return true;
    ...
    getBounds$0: function() {
      var t1 = P.Rectangle$(this._ld31_enemy$_x, this._ld31_enemy$_y, this._ld31_enemy$_width, this._ld31_enemy$_height, null);
      this._ld31_enemy$_bounds = t1;
      return t1;
    },
    _getAccuracy$1: function(i) {
      var t1, t2;
      t1 = this._maxAccuracy;
      t2 = this._minAccuracy;
      if (typeof t1 !== "number")
        return t1.$sub();
      if (typeof t2 !== "number")
        return H.iae(t2);
      t2 = C.C__JSRandom.nextInt$1(t1 - t2 + 1);
      t1 = this._minAccuracy;
      if (typeof t1 !== "number")
        return H.iae(t1);
      return i + t2 + t1;
    },
    Enemy$5: function(x, y, type, wave, player) {
      var t1, t2, acc;
      this._ld31_enemy$_x = x;
      this._ld31_enemy$_y = y;
      this._ld31_enemy$_xSpeed = 0;
      this._ld31_enemy$_ySpeed = 0;
      this._type = type;
      this._ld31_enemy$_wave = wave;
      this._ld31_enemy$_player = player;
      t1 = $.get$Path_paths();
      t2 = C.C__JSRandom.nextInt$1(4);
      if (t2 < 0 || t2 >= 4)
        return H.ioore(t1, t2);
      this._ld31_enemy$_path = t1[t2];
      t1 = this._type;
      if (t1 === 1)
        this._mainColor = "#FF3333";
      else if (t1 === 2)
        this._mainColor = "#33FF33";
      else
        this._mainColor = "#3333FF";
      t1 = this._ld31_enemy$_wave;
      if (t1 < 4)
        acc = 30;
      else
        acc = t1 < 7 ? 35 : 40;
      this._minAccuracy = -acc;
      this._maxAccuracy = acc;
      if (C.C__JSRandom.nextBool$0()) {
        this._ld31_enemy$_gun = U.Gun$(0.8, false);
        this._ld31_enemy$_health = 30;
      } else {
        this._ld31_enemy$_gun = U.Gun$(0.9, false);
        this._ld31_enemy$_health = 20;
      }
      this._ld31_enemy$_toIndex = 0;
      t1 = new Q.Vector(null, null, null);
      t1._x = 0;
      t1._y = 0;
      t1._z = 0;
      this._ld31_enemy$_pathVector = t1;
      this._ld31_enemy$_timer = 0;
    }
  }
}],
["ld31_enemy_manager", "EnemyManager.dart", , A, {
  "^": "",
  EnemyManager_tick: function(delta) {
    var i, t1, t2, t3, t4;
    for (i = 0; t1 = $.EnemyManager__bombs, t2 = t1.length, i < t2; ++i) {
      if (i < 0)
        return H.ioore(t1, i);
      if (t1[i].tick$1(delta)) {
        J.removeAt$1$ax($.EnemyManager__bombs, i);
        --i;
      }
    }
    for (i = 0; t1 = $.EnemyManager__enemies, t2 = t1.length, i < t2; ++i) {
      if (i < 0)
        return H.ioore(t1, i);
      if (t1[i].tick$1(delta)) {
        t1 = $.Gun__emitters;
        t2 = $.EnemyManager__enemies;
        if (i >= t2.length)
          return H.ioore(t2, i);
        t2 = t2[i];
        t1.push(M.ParticleEmitter$(t2._ld31_enemy$_x, t2._ld31_enemy$_y, 8, 4, 4, t2._mainColor, 1, 2, 0, 360, 1, 1, 0.6));
        J.removeAt$1$ax($.EnemyManager__enemies, i);
        --i;
      }
    }
    for (i = 0; t1 = $.EnemyManager__modules, t2 = t1.length, i < t2; ++i) {
      if (i < 0)
        return H.ioore(t1, i);
      if (t1[i].tick$1(delta)) {
        t1 = $.get$EnemyManager__availableSlots();
        t2 = $.EnemyManager__modules;
        if (i >= t2.length)
          return H.ioore(t2, i);
        t2 = t2[i];
        t3 = t2._xo;
        t2 = t2._yo;
        t4 = new Q.Vector(null, null, null);
        t4._x = t3;
        t4._y = t2;
        t4._z = 0;
        t1.push(t4);
        t4 = $.Sound_ahurtSound.cloneNode(false);
        $.Sound_hurtSound = t4;
        J.play$0$x(t4);
        J.removeAt$1$ax($.EnemyManager__modules, i);
        --i;
      }
    }
  },
  EnemyManager_render: function(g) {
    var t1, i, t2, t3, t4, t5, t6, t7;
    for (t1 = J.getInterceptor$x(g), i = 0; t2 = $.EnemyManager__bombs, i < t2.length; ++i) {
      t2 = t2[i];
      t1.set$fillStyle(g, "#000000");
      t3 = t2._anim;
      t4 = t2._ld31_bomb$_width;
      t5 = t2._ld31_bomb$_height;
      if (t3 === 0) {
        t6 = t3 / 2;
        g.fillRect(t2._ld31_bomb$_x - t6, t2._ld31_bomb$_y - t6, t4 + t3, t5 + t3);
      } else {
        ...
        t6 = t2._anim;
        t7 = t6 / 2;
        g.rect(t3 - t7, t2._ld31_bomb$_y - t7, t4 + t6, t5 + t6);
        g.stroke();
      }
    }
    for (i = 0; t2 = $.EnemyManager__enemies, i < t2.length; ++i) {
      t2 = t2[i];
      t1.set$fillStyle(g, t2._mainColor);
      g.fillRect(t2._ld31_enemy$_x, t2._ld31_enemy$_y, t2._ld31_enemy$_width, t2._ld31_enemy$_height);
    }
    for (i = 0; t2 = $.EnemyManager__modules, i < t2.length; ++i) {
      t2 = t2[i];
      t1.set$fillStyle(g, "#FF66FF");
      g.fillRect(t2._ld31_player_module$_x, t2._ld31_player_module$_y, t2._ld31_player_module$_width, t2._ld31_player_module$_height);
    }
  },
  EnemyManager_collisionWithModule: function() {
    var r, i, t1, m, t2, t3, t4, r2;
    if ($.EnemyManager__modules.length > 0) {
      r = $.EnemyManager__player.getBounds$0();
      for (i = 0; t1 = $.EnemyManager__modules, i < t1.length; ++i) {
        m = t1[i];
        t1 = m._ld31_player_module$_x;
        t2 = m._ld31_player_module$_y;
        t3 = m._ld31_player_module$_width;
        t4 = m._ld31_player_module$_height;
        r2 = new P.Rectangle(t1, t2, t3, t4);
        r2.$builtinTypeInfo = [null];
        m._bounds = r2;
        if (r.intersects$1(r2) && !m._isAttached) {
          m._isAttached = true;
          t1 = $.Sound_aattatchSound.cloneNode(false);
          $.Sound_attatchSound = t1;
          J.play$0$x(t1);
        }
      }
    }
...
["ld31_entity_player", "Player.dart", , V, {
  "^": "",
  Player: {
    "^": "Object;_ld31_entity_player$_health,_ld31_entity_player$_maxHealth,_width,_height,_ld31_entity_player$_x,_ld31_entity_player$_y,_xSpeed,_ySpeed,_moveSpeed,_ld31_entity_player$_maxSpeed,_friction,_ld31_entity_player$_type,_ld31_entity_player$_hud,_bombTimer,trail,_gun,bounds",
    getBounds$0: function() {
      var t1 = P.Rectangle$(this._ld31_entity_player$_x, this._ld31_entity_player$_y, this._width, this._height, null);
      this.bounds = t1;
      return t1;
    },
    Player$3: function(x, y, hud) {
      this._ld31_entity_player$_x = x;
      this._ld31_entity_player$_y = y;
      this._ld31_entity_player$_hud = hud;
      this._xSpeed = 0;
      this._ySpeed = 0;
      hud._health = this._ld31_entity_player$_health;
      hud._maxHealth = this._ld31_entity_player$_maxHealth;
      this.trail = M.ParticleEmitter$(x, y, -1, 3, 3, "#FF33FF", 1, 2, 0, 360, 1, 1, 0.5);
      this._gun = U.Gun$(0.45, true);
      this.bounds = P.Rectangle$(this._ld31_entity_player$_x, this._ld31_entity_player$_y, this._width, this._height, null);
    }
  }
}],
["ld31_game", "Game.dart", , R, {
  "^": "",
  Game: {
    "^": "Object;_lastTimestamp,_canvas,g,_hud",
    _loop$1: [function(_d) {
      var t1, t2, elapsed;
      t1 = Date.now();
      ...
      if (t1._health < 0)
        t1._health = 0;
      J.set$fillStyle$x(this.g, "#CCCCCC");
      J.fillRect$4$x(this.g, 0, 0, 800, 600);
      t1 = $.State__state;
      if (t1 != null)
        t1.render$1(this.g);
      t1 = this._hud;
      J.set$fillStyle$x(t1.g2, "#CCCCCC");
      J.fillRect$4$x(t1.g2, 0, 0, 800, 32);
      J.set$fillStyle$x(t1.g2, "#333333");
      J.fillText$3$x(t1.g2, "Health:", 2, 26);
      J.fillText$3$x(t1.g2, "Wave #" + C.JSInt_methods.toString$0(t1._wave), 350, 26);
      J.fillText$3$x(t1.g2, "Bombs: " + C.JSInt_methods.toString$0(t1._bombs), 550, 26);
      J.set$fillStyle$x(t1.g2, "#999999");
      J.fillRect$4$x(t1.g2, 108, 3, $.HUD_HEALTH_BAR_WIDTH, 26);
      J.set$fillStyle$x(t1.g2, "#00FF00");
      J.fillRect$4$x(t1.g2, 110, 4, t1._health / t1._maxHealth * ($.HUD_HEALTH_BAR_WIDTH - 4), 24);
      t1 = window;
      t2 = this.get$_loop();
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(t2));
    }, "call$1", "get$_loop", 2, 0, 20],
    Game$2: function(canvas, hudCanvas) {
      var t1;
      this._canvas = canvas;
      t1 = J.getInterceptor$x(canvas);
      t1.set$width(canvas, 800);
      t1.set$height(canvas, 600);
      this.g = t1.getContext$1(canvas, "2d");
      canvas.focus();
      t1 = new V.HUD(null, null, null, null, null, null);
      t1.HUD$1(hudCanvas);
      this._hud = t1;
      K.KeyManager$();
      X.MouseManager$(canvas);
      t1 = W.AudioElement_AudioElement("res/hurt.wav");
      t1.load();
      $.Sound_ahurtSound = t1;
      t1 = W.AudioElement_AudioElement("res/explosion.wav");
      t1.load();
      $.Sound_aexplosionSound = t1;
      t1 = W.AudioElement_AudioElement("res/attatch.wav");
      t1.load();
      $.Sound_aattatchSound = t1;
      t1 = new R.GameState(null, null, null);
      t1.GameState$1(this._hud);
      $.Game_gameState = t1;
      t1 = new U.MenuState(null, false, false, null, 0);
      t1.MenuState$0();
      $.Game_menuState = t1;
      t1 = new B.DeathState(null, null, 0);
      t1.DeathState$0();
      $.Game_deathState = t1;
      M.State_setState($.Game_menuState);
    },
    static: {"^": "Game_WIDTH,Game_HEIGHT,Game_gameState,Game_menuState,Game_deathState"}
  }
}],
["ld31_gun", "Gun.dart", , U, {
  "^": "",
  Gun: {
    "^": "Object;_fireDelay,_ld31_gun$_timer,_canFire,_isFromPlayer",
    tickPlayer$5: function(delta, x, y, offsetx, offsety) {
      var t1, t2;
      t1 = this._ld31_gun$_timer += delta;
      if (!this._canFire) {
        if (t1 >= this._fireDelay)
          this._canFire = true;
      } else if ($.MouseManager__pressed) {
        t1 = $.MouseManager__mouseX;
        if (typeof t1 !== "number")
          return t1.$add();
        t2 = $.MouseManager__mouseY;
        if (typeof t2 !== "number")
          return t2.$add();
        this._fire$4(t1 + offsetx, t2 + offsety, x, y);
        this._canFire = false;
        this._ld31_gun$_timer = 0;
      }
    },
    _fire$4: function(mx, my, x, y) {
      var rad, t1, t2;
      rad = Math.atan2(H.checkNum(my - y), H.checkNum(mx - x));
      t1 = $.Gun__bullets;
      t2 = new R.Bullet(6, 6, null, null, null, null, null);
      t2.Bullet$4(x, y, rad, this._isFromPlayer);
      t1.push(t2);
    },
    Gun$2: function(fireDelay, isFromPlayer) {
    ...
    static: {"^": "Gun__bullets,Gun__emitters", Gun$: function(fireDelay, isFromPlayer) {
        var t1 = new U.Gun(null, null, null, null);
        t1.Gun$2(fireDelay, isFromPlayer);
        return t1;
      }, Gun_tickBullets: function(delta) {
        var i, t1, t2;
        if ($.Gun__bullets.length > 0)
          for (i = 0; t1 = $.Gun__bullets, t2 = t1.length, i < t2; ++i) {
            if (i < 0)
              return H.ioore(t1, i);
            if (t1[i].tick$1(delta)) {
              J.removeAt$1$ax($.Gun__bullets, i);
              --i;
            }
          }
        if ($.Gun__emitters.length > 0)
          for (i = 0; t1 = $.Gun__emitters, t2 = t1.length, i < t2; ++i) {
            if (i < 0)
              return H.ioore(t1, i);
            if (t1[i].tick$1(delta)) {
              J.removeAt$1$ax($.Gun__emitters, i);
              --i;
            }
          }
      }, Gun_collision: function(r, isPlayer) {
        var t1, r2, timesCollided, i, t2, t3, b;
        if ($.Gun__bullets.length > 0)
          for (t1 = !isPlayer, r2 = null, timesCollided = 0, i = 0; t2 = $.Gun__bullets, t3 = t2.length, i < t3; ++i) {
            if (i < 0)
              return H.ioore(t2, i);
            b = t2[i];
            if (!(isPlayer && !b._ld31_bullet$_isFromPlayer))
              t2 = t1 && b._ld31_bullet$_isFromPlayer;
            else
              t2 = true;
            if (t2) {
              t2 = b._ld31_bullet$_x;
              t3 = b._ld31_bullet$_y;
              r2 = new P.Rectangle(t2, t3, b._ld31_bullet$_width, b._ld31_bullet$_height);
              r2.$builtinTypeInfo = [null];
              if (r2.intersects$1(r)) {
                ++timesCollided;
                $.Gun__emitters.push(M.ParticleEmitter$(b._ld31_bullet$_x, b._ld31_bullet$_y, 16, 4, 4, "#333333", 1, 1, 0, 360, 1, 1, 0.5));
                J.removeAt$1$ax($.Gun__bullets, i);
                --i;
              }
            }
      ...
      }, Gun_renderBullets: function(g) {
        var i, t1;
        J.set$fillStyle$x(g, "#222222");
        for (i = 0; t1 = $.Gun__bullets, i < t1.length; ++i) {
          t1 = t1[i];
          g.fillRect(t1._ld31_bullet$_x, t1._ld31_bullet$_y, t1._ld31_bullet$_width, t1._ld31_bullet$_height);
        }
        for (i = 0; t1 = $.Gun__emitters, i < t1.length; ++i)
          t1[i].render$1(g);
      }}
  }
}],
["ld31_hud", "HUD.dart", , V, {
  "^": "",
  HUD: {
    "^": "Object;_health,_maxHealth,_wave,_bombs,_ld31_hud$_canvas,g2",
    HUD$1: function(canvas) {
      var t1;
      this._ld31_hud$_canvas = canvas;
      t1 = J.getInterceptor$x(canvas);
      t1.set$width(canvas, 800);
      t1.set$height(canvas, 32);
      t1 = t1.getContext$1(canvas, "2d");
      this.g2 = t1;
      J.set$font$x(t1, "30px Arial");
      this._maxHealth = 100;
      this._health = 100;
      this._wave = 1;
      this._bombs = 1;
    },
    static: {"^": "HUD_HUDHEIGHT,HUD_HEALTH_BAR_WIDTH"}
  }
}],
["ld31_key", "KeyManager.dart", , K, {
  "^": "",
  KeyManager: {
    "^": "Object;",
    KeyManager$0: function() {
      var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new K.KeyManager_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new K.KeyManager_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {"^": "KeyManager__keys", KeyManager$: function() {
        var t1 = new K.KeyManager();
        t1.KeyManager$0();
        return t1;
      }}
  },
  KeyManager_closure: {
    "^": "Closure:21;",
    call$1: function(e) {
      $.get$KeyManager__keys().add$1(0, J.get$keyCode$x(e));
    },
    $isFunction: true
  },
  KeyManager_closure0: {
    "^": "Closure:21;",
    call$1: function(e) {
      $.get$KeyManager__keys().remove$1(0, J.get$keyCode$x(e));
    },
    $isFunction: true
  }
}],
["ld31_mouse", "MouseManager.dart", , X, {
  "^": "",
  MouseManager: {
    "^": "Object;_ld31_mouse$_xo,_ld31_mouse$_yo",
    MouseManager$1: function(canvas) {
      var t1;
      this._ld31_mouse$_xo = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(canvas.offsetLeft));
      this._ld31_mouse$_yo = C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(canvas.offsetTop));
      $.MouseManager__mouseX = 0;
      $.MouseManager__mouseY = 0;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(canvas, "mousemove", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new X.MouseManager_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(canvas, "mousedown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new X.MouseManager_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(canvas, "mouseup", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new X.MouseManager_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    static: {"^": "MouseManager__mouseX,MouseManager__mouseY,MouseManager__pressed", MouseManager$: function(canvas) {
        var t1 = new X.MouseManager(null, null);
        t1.MouseManager$1(canvas);
        return t1;
      }}
  },
  MouseManager_closure: {
    "^": "Closure:22;this_0",
    call$1: function(e) {
      var t1, t2, t3, t4;
      ...
      t2 = t2.get$x(t2);
      t3 = this.this_0;
      t4 = t3._ld31_mouse$_xo;
      if (typeof t2 !== "number")
        return t2.$sub();
      $.MouseManager__mouseX = t2 - t4;
      t1 = t1.get$client(e);
      t1 = t1.get$y(t1);
      t3 = t3._ld31_mouse$_yo;
      if (typeof t1 !== "number")
        return t1.$sub();
      $.MouseManager__mouseY = t1 - t3;
    },
    $isFunction: true
  },
  MouseManager_closure0: {
    "^": "Closure:22;",
    call$1: function(e) {
      $.MouseManager__pressed = true;
    },
    $isFunction: true
  },
  MouseManager_closure1: {
    "^": "Closure:22;",
    call$1: function(e) {
      $.MouseManager__pressed = false;
    },
    $isFunction: true
  }
}],
["ld31_particle", "Particle.dart", , S, {
  "^": "",
  Particle: {
    "^": "Object;_ld31_particle$_x,_ld31_particle$_y,_ld31_particle$_xSpeed,_ld31_particle$_ySpeed,_life,_ld31_particle$_timer,_ld31_particle$_style",
    tick$1: function(delta) {
      var t1 = this._ld31_particle$_timer += delta;
      if (t1 > this._life)
        return true;
      this._ld31_particle$_x = this._ld31_particle$_x + this._ld31_particle$_xSpeed;
      this._ld31_particle$_y = this._ld31_particle$_y + this._ld31_particle$_ySpeed;
      return false;
    },
    Particle$5: function(x, y, degAngle, speed, life) {
      var angleR;
      this._ld31_particle$_x = x;
      this._ld31_particle$_y = y;
      this._life = life;
      this._ld31_particle$_timer = 0;
      angleR = degAngle * 3.141592653589793 / 180;
      this._ld31_particle$_xSpeed = speed * Math.cos(H.checkNum(angleR));
      this._ld31_particle$_ySpeed = -speed * Math.sin(H.checkNum(angleR));
    },
    static: {Particle$: function(x, y, degAngle, speed, life) {
        var t1 = new S.Particle(null, null, null, null, null, null, null);
        t1.Particle$5(x, y, degAngle, speed, life);
        return t1;
      }}
  }
}],
["ld31_particleEmitter", "ParticleEmitter.dart", , M, {
  "^": "",
  ParticleEmitter: {
    "^": "Object;_particles,_toRemove,_ld31_particleEmitter$_x,_ld31_particleEmitter$_y,_style,_amount,_generated,_removed,_particleWidth,_particleHeight,_minSpeed,_maxSpeed,_minAngle,_maxAngle,_minLife,_maxLife,_stableLife",
    tick$1: function(delta) {
      var t1, t2, t3, t4, t5, t6, i;
      t1 = this._amount;
      if (t1 === -1 || this._generated < t1) {
        t1 = this._stableLife;
        t2 = this._particles;
        t3 = this._minAngle;
        t4 = this._maxAngle;
        t5 = this._ld31_particleEmitter$_x;
        t6 = this._ld31_particleEmitter$_y;
        if (t1 === 0)
          t2.push(S.Particle$(t5, t6, this._randomize$2(t3, t4), this._randomize$2(this._minSpeed, this._maxSpeed), this._randomize$2(this._minLife, this._maxLife)));
        else
          t2.push(S.Particle$(t5, t6, this._randomize$2(t3, t4), this._randomize$2(this._minSpeed, this._maxSpeed), this._stableLife));
        ++this._generated;
      }
      for (i = 0; t1 = this._particles, i < t1.length; ++i)
        if (t1[i].tick$1(delta))
          this._toRemove.push(i);
      for (i = 0; t1 = this._toRemove, i < t1.length; ++i) {
        t1 = t1[i];
        t2 = this._particles;
        if (t1 < t2.length)
    ...
    render$1: function(g) {
      var i, t1, t2, t3;
      g.fillStyle = this._style;
      for (i = 0; t1 = this._particles, i < t1.length; ++i) {
        t1 = t1[i];
        t2 = this._particleWidth;
        t3 = this._particleHeight;
        g.fillRect(t1._ld31_particle$_x, t1._ld31_particle$_y, t2, t3);
      }
    },
    _randomize$2: function(min, max) {
      return C.C__JSRandom.nextInt$1(max - min + 1) + min;
    },
    ParticleEmitter$13: function(x, y, amount, particleWidth, particleHeight, style, minSpeed, maxSpeed, minAngle, maxAngle, minLife, maxLife, stableLife) {
      this._particles = [];
      this._toRemove = [];
      this._ld31_particleEmitter$_x = x;
      this._ld31_particleEmitter$_y = y;
      this._amount = amount;
      ...
      this._stableLife = stableLife;
      this._generated = 0;
      this._removed = 0;
    },
    static: {ParticleEmitter$: function(x, y, amount, particleWidth, particleHeight, style, minSpeed, maxSpeed, minAngle, maxAngle, minLife, maxLife, stableLife) {
        var t1 = new M.ParticleEmitter(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        t1.ParticleEmitter$13(x, y, amount, particleWidth, particleHeight, style, minSpeed, maxSpeed, minAngle, maxAngle, minLife, maxLife, stableLife);
        return t1;
      }}
  }
}],
["ld31_path", "Path.dart", , Q, {
  "^": "",
  Path: {
    "^": "Object;_threshhold,_coords,_resultVector",
    moveAlongPath$3: function(x, y, index) {
      var t1, t2, tx, ty, angle;
      t1 = this._coords;
      t2 = t1.length;
      ...
      tx = t1._x;
      ty = t1._y;
      angle = Math.atan2(H.checkNum(ty - y), H.checkNum(tx - x));
      this._resultVector._x = Math.cos(H.checkNum(angle));
      this._resultVector._y = Math.sin(H.checkNum(angle));
      t1 = this._threshhold;
      if (x > tx - t1 && x < tx + t1) {
        t1 = y > ty - t1 && y < ty + t1;
        t2 = this._resultVector;
        if (t1)
          t2._z = index + 1;
        else
          t2._z = index;
        ...
        t1 = this._resultVector;
        t1._z = index;
      }
      return t1;
    },
    static: {"^": "Path__circlePathCoordinates,Path__circlePath,Path__diag1PathCoordinates,Path__diag1Path,Path__diag2PathCoordinates,Path__diag2Path,Path__diag3PathCoordinates,Path__diag3Path,Path_paths"}
  }
}],
["ld31_player_module", "PlayerModule.dart", , E, {
  "^": "",
  PlayerModule: {
    "^": "Object;_ld31_player_module$_player,_ld31_player_module$_health,_ld31_player_module$_width,_ld31_player_module$_height,_ld31_player_module$_x,_ld31_player_module$_y,_ld31_player_module$_xSpeed,_ld31_player_module$_ySpeed,_ld31_player_module$_moveSpeed,_ld31_player_module$_maxSpeed,_ld31_player_module$_friction,_xo,_yo,_ld31_player_module$_gun,_bounds,_isAttached,_toIndex,_path,_pathVector",
    tick$1: function(delta) {
      var t1, t2, t3, times, t4, t5;
      if (this._isAttached) {
        t1 = this._ld31_player_module$_player;
        t2 = t1._ld31_entity_player$_x;
        t3 = this._xo;
        t2 += t3;
        this._ld31_player_module$_x = t2;
        t1 = t1._ld31_entity_player$_y + this._yo;
        this._ld31_player_module$_y = t1;
        this._ld31_player_module$_gun.tickPlayer$5(delta, t2 + this._ld31_player_module$_width / 2, t1 + this._ld31_player_module$_height / 2, C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t3 / 20)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(this._yo / 20)));
        times = U.Gun_collision(this.getBounds$0(), true);
        this._ld31_player_module$_health = this._ld31_player_module$_health - times * 10;
      } else {
        t1 = this._path.moveAlongPath$3(this._ld31_player_module$_x, this._ld31_player_module$_y, this._toIndex);
        this._pathVector = t1;
        t2 = this._ld31_player_module$_moveSpeed * 4;
        t3 = t2 * t1._x;
        this._ld31_player_module$_xSpeed = t3;
        t2 *= t1._y;
        this._ld31_player_module$_ySpeed = t2;
        this._toIndex = t1._z;
        if (t3 > 0) {
          t1 = t3 - this._ld31_player_module$_friction;
          this._ld31_player_module$_xSpeed = t1;
          if (t1 < 0) {
            this._ld31_player_module$_xSpeed = 0;
            t1 = 0;
          }
        } else if (t3 < 0) {
          t1 = t3 + this._ld31_player_module$_friction;
          ...
          t1 = t3;
        if (t2 > 0) {
          t2 -= this._ld31_player_module$_friction;
          this._ld31_player_module$_ySpeed = t2;
          if (t2 < 0) {
            this._ld31_player_module$_ySpeed = 0;
            t2 = 0;
          }
        } else if (t2 < 0) {
          t2 += this._ld31_player_module$_friction;
        ...
        t3 = this._ld31_player_module$_x;
        if (t3 + t1 < 0) {
          this._ld31_player_module$_x = 0;
          this._ld31_player_module$_xSpeed = 0;
          t1 = 0;
          t3 = 0;
        } else {
          t4 = this._ld31_player_module$_width;
          if (t3 + t4 + t1 >= 800) {
            t1 = 800 - t4 - 0;
            this._ld31_player_module$_x = t1;
            this._ld31_player_module$_xSpeed = 0;
            t3 = t1;
            t1 = 0;
          }
        }
        t4 = this._ld31_player_module$_y;
        if (t4 + t2 < 0) {
          this._ld31_player_module$_y = 0;
          this._ld31_player_module$_ySpeed = 0;
          t2 = 0;
          t4 = 0;
        } else {
          t5 = this._ld31_player_module$_height;
          if (t4 + t5 + t2 >= 600) {
            t2 = 600 - t5 - 0;
            this._ld31_player_module$_y = t2;
            this._ld31_player_module$_ySpeed = 0;
            t4 = t2;
            t2 = 0;
          }
        }
        this._ld31_player_module$_x = t3 + t1;
        this._ld31_player_module$_y = t4 + t2;
      }
      if (this._ld31_player_module$_health <= 0)
        return true;
      return false;
    },
    getBounds$0: function() {
      var t1 = P.Rectangle$(this._ld31_player_module$_x, this._ld31_player_module$_y, this._ld31_player_module$_width, this._ld31_player_module$_height, null);
      this._bounds = t1;
      return t1;
    },
    PlayerModule$5: function(player, x, y, xo, yo) {
      var t1, t2;
      this._ld31_player_module$_player = player;
      this._xo = xo;
      this._yo = yo;
      this._ld31_player_module$_x = x;
      this._ld31_player_module$_y = y;
      t1 = player._width;
      this._ld31_player_module$_width = t1;
      t2 = player._height;
      this._ld31_player_module$_height = t2;
      this._bounds = P.Rectangle$(x, y, t1, t2, null);
      this._ld31_player_module$_health = 40;
      ...
      if (t2 < 0 || t2 >= 4)
        return H.ioore(t1, t2);
      this._path = t1[t2];
      t2 = new Q.Vector(null, null, null);
      t2._x = 0;
      t2._y = 0;
      t2._z = 0;
      this._pathVector = t2;
      this._ld31_player_module$_gun = U.Gun$(0.8, true);
    }
  }
}],
["ld31_state", "State.dart", , M, {
  "^": "",
  State_setState: function(s) {
    var t1 = $.State__state;
    if (t1 != null)
      t1.onHide$0();
    $.State__state = s;
...
["ld31_state_death", "DeathState.dart", , B, {
  "^": "",
  DeathState: {
    "^": "State;_playBounds,_hover,_timer",
    tick$1: function(delta) {
      var t1 = this._timer += delta;
      if (t1 > 1)
        if (this._playBounds.containsRectangle$1(P.Rectangle$($.MouseManager__mouseX, $.MouseManager__mouseY, 1, 1, null))) {
          this._hover = true;
          if ($.MouseManager__pressed)
            M.State_setState($.Game_menuState);
        } else
          this._hover = false;
    },
    render$1: function(g) {
      J.getInterceptor$x(g).set$fillStyle(g, "#333333");
      g.font = "64px Calibri";
      C.CanvasRenderingContext2D_methods.fillText$3(g, "You made it to wave: ", 100, 100);
      g.font = "100px Calibri";
      g.fillStyle = "GREEN";
      C.CanvasRenderingContext2D_methods.fillText$3(g, J.toString$0($.DeathState__wave), 350, 200);
      if (this._hover)
        g.fillStyle = "GREEN";
      else
        g.fillStyle = "RED";
      C.CanvasRenderingContext2D_methods.fillText$3(g, "MENU!", 200, 428);
    },
    onShow$0: function() {
      this._timer = 0;
    },
    ...
    DeathState$0: function() {
      this._playBounds = P.Rectangle$(200, 328, 325, 100, null);
      this._hover = false;
    },
    static: {"^": "DeathState__wave"}
  }
}],
["ld31_state_game", "GameState.dart", , R, {
  "^": "",
  GameState: {
    "^": "State;_waveManager,_player,_ld31_state_game$_hud",
    tick$1: function(delta) {
      var t1, t2, t3, t4, t5, t6, t7, t8, times;
      t1 = this._player;
      t1._bombTimer += delta;
      t2 = t1._width;
      t3 = t2 / 2;
      t4 = t1._height;
      t5 = t4 / 2;
      t1._gun.tickPlayer$5(delta, t1._ld31_entity_player$_x + t3, t1._ld31_entity_player$_y + t5, 0, 0);
      t6 = $.get$KeyManager__keys();
      if (t6.contains$1(0, 65) || t6.contains$1(0, 37)) {
        t7 = t1._xSpeed - t1._moveSpeed;
        t1._xSpeed = t7;
        t8 = -t1._ld31_entity_player$_maxSpeed;
        if (t7 < t8)
          t1._xSpeed = t8;
      } else if (t6.contains$1(0, 68) || t6.contains$1(0, 39)) {
        t7 = t1._xSpeed + t1._moveSpeed;
        t1._xSpeed = t7;
        t8 = t1._ld31_entity_player$_maxSpeed;
        if (t7 > t8)
      ...
      if (t6.contains$1(0, 87) || t6.contains$1(0, 38)) {
        t7 = t1._ySpeed - t1._moveSpeed;
        t1._ySpeed = t7;
        t8 = -t1._ld31_entity_player$_maxSpeed;
        if (t7 < t8)
          t1._ySpeed = t8;
      } else if (t6.contains$1(0, 83) || t6.contains$1(0, 40)) {
        t7 = t1._ySpeed + t1._moveSpeed;
        t1._ySpeed = t7;
        t8 = t1._ld31_entity_player$_maxSpeed;
        if (t7 > t8)
      ...
      if (t1._bombTimer > 1.5 && t6.contains$1(0, 32) && t1._ld31_entity_player$_hud._bombs > 0) {
        --t1._ld31_entity_player$_hud._bombs;
        t6 = new F.Bomb(null, 2.5, null, null, 0, 9.5, 14, 14, 164, null, null);
        t6.Bomb$2(t1._ld31_entity_player$_x, t1._ld31_entity_player$_y);
        $.EnemyManager__bombs.push(t6);
        t1._bombTimer = 0;
      }
      t6 = t1._xSpeed;
      if (t6 > 0) {
      ...
      t8 = t1._ld31_entity_player$_x;
      if (t8 + t6 < 0) {
        t1._ld31_entity_player$_x = 0;
        t2 = 0;
      } else if (t8 + t2 + t6 >= 800) {
        t2 = 800 - t2 - 0;
        t1._ld31_entity_player$_x = t2;
      } else
        t2 = t8;
      t8 = t1._ld31_entity_player$_y;
      if (t8 + t7 < 0) {
        t1._ld31_entity_player$_y = 0;
        t4 = 0;
      } else if (t8 + t4 + t7 >= 600) {
        t4 = 600 - t4 - 0;
        t1._ld31_entity_player$_y = t4;
      } else
        t4 = t8;
      t6 = t2 + t6;
      t1._ld31_entity_player$_x = t6;
      t7 = t4 + t7;
      t1._ld31_entity_player$_y = t7;
      t4 = t1.trail;
      t4._ld31_particleEmitter$_x = t6 + t3;
      t4._ld31_particleEmitter$_y = t7 + t5;
      t4.tick$1(delta);
      times = U.Gun_collision(t1.getBounds$0(), true);
      A.EnemyManager_collisionWithModule();
      t4 = t1._ld31_entity_player$_health - times * 10;
      t1._ld31_entity_player$_health = t4;
      t1 = t1._ld31_entity_player$_hud;
      t1._health = t4;
      if (t4 <= 0) {
        $.DeathState__wave = t1._wave;
        M.State_setState($.Game_deathState);
        t1 = $.Sound_aexplosionSound.cloneNode(false);
        $.Sound_explosionSound = t1;
        J.play$0$x(t1);
      }
      ...
      A.EnemyManager_tick(delta);
      U.Gun_tickBullets(delta);
      this._waveManager.tick$1(delta);
    },
    render$1: function(g) {
      var t1;
      U.Gun_renderBullets(g);
      t1 = this._player;
      J.getInterceptor$x(g).set$fillStyle(g, "#FF00FF");
      g.fillRect(t1._ld31_entity_player$_x, t1._ld31_entity_player$_y, t1._width, t1._height);
      t1.trail.render$1(g);
      A.EnemyManager_render(g);
      t1 = this._waveManager;
      if (t1._doDisplay) {
        g.font = "56px Arial";
        g.fillStyle = "#333333";
        C.CanvasRenderingContext2D_methods.fillText$3(g, "Next Wave Coming - " + C.JSInt_methods.toString$0(t1._waveWaitTime - C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(t1._ld31_wave_manager$_timer))) + "!", 100, 300);
      }
    },
    onShow$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8;
      if ($.get$EnemyManager__availableSlots().length < 8) {
        t1 = new Q.Vector(null, null, null);
        t1._x = -20;
        t1._y = 0;
        t1._z = 0;
        ...
        t2._y = 0;
        t2._z = 0;
        t3 = new Q.Vector(null, null, null);
        t3._x = 0;
        t3._y = -20;
        t3._z = 0;
        t4 = new Q.Vector(null, null, null);
        ...
        t4._y = 20;
        t4._z = 0;
        t5 = new Q.Vector(null, null, null);
        t5._x = -20;
        t5._y = -20;
        t5._z = 0;
        t6 = new Q.Vector(null, null, null);
        t6._x = 20;
        t6._y = -20;
        t6._z = 0;
        t7 = new Q.Vector(null, null, null);
        t7._x = 20;
        t7._y = 20;
        t7._z = 0;
        t8 = new Q.Vector(null, null, null);
        t8._x = -20;
        t8._y = 20;
        t8._z = 0;
        $.EnemyManager__availableSlots = [t1, t2, t3, t4, t5, t6, t7, t8];
      }
      J.set$length$asx($.EnemyManager__modules, 0);
      J.set$length$asx($.EnemyManager__enemies, 0);
      J.set$length$asx($.EnemyManager__bombs, 0);
      t1 = this._player;
      t1._ld31_entity_player$_x = 400;
      t1._ld31_entity_player$_y = 300;
      t1._xSpeed = 0;
      t1._ySpeed = 0;
      t2 = t1._gun;
      t2._canFire = true;
      t2._ld31_gun$_timer = 0;
      t1._ld31_entity_player$_health = t1._ld31_entity_player$_maxHealth;
      t1._bombTimer = 0;
      J.set$length$asx($.Gun__bullets, 0);
      J.set$length$asx($.Gun__emitters, 0);
      t1 = this._waveManager;
      t1._ld31_wave_manager$_wave = 0;
      t1._once = false;
      t1._ld31_wave_manager$_timer = 0;
      t1._doDisplay = true;
      t1 = this._ld31_state_game$_hud;
      t1._health = this._player._ld31_entity_player$_health;
      t1._wave = 0;
      t1._bombs = 1;
    },
    onHide$0: function() {
    },
    GameState$1: function(hud) {
      var t1, t2;
      this._ld31_state_game$_hud = hud;
      t1 = new V.Player(130, 130, 20, 20, null, null, null, null, 1, 6, 0.3, 0, null, 0, null, null, null);
      t1.Player$3(400, 300, hud);
      this._player = t1;
      $.EnemyManager__enemies = [];
      $.EnemyManager__modules = [];
      $.EnemyManager__bombs = [];
      $.EnemyManager__player = t1;
      t2 = new R.WaveManager(null, null, null, null, null, null, null, null);
      t2.WaveManager$2(t1, hud);
      this._waveManager = t2;
    }
  }
}],
["ld31_state_menu", "MenuState.dart", , U, {
  "^": "",
  MenuState: {
    "^": "State;_emitters,_ld31_state_menu$_hover,_before,_ld31_state_menu$_playBounds,_ld31_state_menu$_timer",
    tick$1: function(delta) {
      var i, t1;
      for (i = 0; i < 4; ++i)
        this._emitters[i].tick$1(delta);
      t1 = this._ld31_state_menu$_timer += delta;
      if (t1 > 1)
        if (this._ld31_state_menu$_playBounds.containsRectangle$1(P.Rectangle$($.MouseManager__mouseX, $.MouseManager__mouseY, 1, 1, null))) {
          this._ld31_state_menu$_hover = true;
          if ($.MouseManager__pressed)
            M.State_setState($.Game_gameState);
        } else
          this._ld31_state_menu$_hover = false;
    },
    render$1: function(g) {
      var i;
      J.getInterceptor$x(g).set$font(g, "100px Calibri");
      g.fillStyle = "#333333";
      C.CanvasRenderingContext2D_methods.fillText$3(g, "BLOCK", 150, 136);
      C.CanvasRenderingContext2D_methods.fillText$3(g, "BRIGADE", 200, 244);
      if (this._ld31_state_menu$_hover)
        g.fillStyle = "GREEN";
      else
        g.fillStyle = "RED";
      C.CanvasRenderingContext2D_methods.fillText$3(g, "PLAY!", 200, 428);
      for (i = 0; i < 4; ++i)
        this._emitters[i].render$1(g);
    },
    onShow$0: function() {
    },
    onHide$0: function() {
      this._before = false;
      this._ld31_state_menu$_timer = 0;
    },
    MenuState$0: function() {
      this._emitters = [M.ParticleEmitter$(700, 600, -1, 4, 4, "#639FC9", 2, 4, 45, 135, 1, 2, 0), M.ParticleEmitter$(500, 600, -1, 4, 4, "#35FF93", 2, 4, 45, 135, 1, 2, 0), M.ParticleEmitter$(300, 600, -1, 4, 4, "#FF66C3", 2, 4, 45, 135, 1, 2, 0), M.ParticleEmitter$(100, 600, -1, 4, 4, "#66C396", 2, 4, 45, 135, 1, 2, 0)];
      this._ld31_state_menu$_playBounds = P.Rectangle$(200, 328, 225, 100, null);
    }
  }
}],
["ld31_vector", "Vector.dart", , Q, {
  "^": "",
  Vector: {
    "^": "Object;_x,_y,_z"
  }
}],
["ld31_wave_manager", "WaveManager.dart", , R, {
  "^": "",
  WaveManager: {
    "^": "Object;_ld31_wave_manager$_player,_ld31_wave_manager$_hud,_ld31_wave_manager$_wave,_ld31_wave_manager$_timer,_waveWaitTime,_doDisplay,_once,_tempVector",
    tick$1: function(delta) {
      var t1, i, t2, t3, t4, t5;
      t1 = this._ld31_wave_manager$_timer += delta;
      if ($.EnemyManager__enemies.length <= 0) {
        if (!this._once) {
          this._once = true;
          this._ld31_wave_manager$_timer = 0;
          t1 = ++this._ld31_wave_manager$_wave;
          this._ld31_wave_manager$_hud._wave = t1;
          t1 = 0;
        }
        if (t1 > this._waveWaitTime) {
          for (i = 0; t1 = this._ld31_wave_manager$_wave, i < t1; ++i) {
            t1 = new S.Enemy(0.6, 3, 0.3, null, null, 20, 20, null, null, null, null, null, null, null, null, null, null, null, 1, null, null, null, null);
            t1.Enemy$5(C.C__JSRandom.nextInt$1(771), C.C__JSRandom.nextInt$1(571), C.C__JSRandom.nextInt$1(3) + 1, this._ld31_wave_manager$_wave, this._ld31_wave_manager$_player);
            $.EnemyManager__enemies.push(t1);
          }
          if (t1 <= 6)
            t1 = C.JSInt_methods.$mod(t1, 2) === 0 && $.get$EnemyManager__availableSlots().length > 0;
          else
            t1 = true;
          if (t1) {
            t1 = $.get$EnemyManager__availableSlots();
            if (0 >= t1.length)
              return H.ioore(t1, 0);
            this._tempVector = t1[0];
            C.JSArray_methods.removeAt$1(t1, 0);
            t1 = this._ld31_wave_manager$_player;
            t2 = C.C__JSRandom.nextInt$1(771);
            t3 = C.C__JSRandom.nextInt$1(571);
            t4 = this._tempVector;
            t5 = new E.PlayerModule(null, null, null, null, null, null, 0, 0, 1, 6, 0.3, null, null, null, null, null, null, null, null);
            t5.PlayerModule$5(t1, t2, t3, t4._x, t4._y);
            $.EnemyManager__modules.push(t5);
          }
          t1 = this._ld31_wave_manager$_wave;
          if (t1 > 12) {
            if (C.JSInt_methods.$mod(t1, 3) === 0)
              ++this._ld31_wave_manager$_hud._bombs;
          } else if (C.JSInt_methods.$mod(t1, 4) === 0)
            ++this._ld31_wave_manager$_hud._bombs;
          this._once = false;
          this._doDisplay = false;
        } else
          this._doDisplay = true;
      } else
        this._once = false;
    },
    WaveManager$2: function(player, hud) {
      this._ld31_wave_manager$_wave = 0;
      this._ld31_wave_manager$_timer = 0;
      this._waveWaitTime = 5;
      this._doDisplay = true;
      this._ld31_wave_manager$_player = player;
      this._ld31_wave_manager$_hud = hud;
      this._once = false;
    }
  }
}],
...
$.Bullet__speed = 8.5;
$.EnemyManager__enemies = null;
$.EnemyManager__modules = null;
$.EnemyManager__bombs = null;
$.EnemyManager__player = null;
$.Game_gameState = null;
$.Game_menuState = null;
$.Game_deathState = null;
$.Gun__bullets = null;
$.Gun__emitters = null;
$.HUD_HEALTH_BAR_WIDTH = 200;
$.MouseManager__mouseX = null;
$.MouseManager__mouseY = null;
$.MouseManager__pressed = false;
$.Sound_hurtSound = null;
$.Sound_explosionSound = null;
$.Sound_attatchSound = null;
$.Sound_ahurtSound = null;
$.Sound_aexplosionSound = null;
$.Sound_aattatchSound = null;
$.State__state = null;
$.DeathState__wave = null;
...
Isolate.$lazy($, "_availableSlots", "EnemyManager__availableSlots", "get$EnemyManager__availableSlots", function() {
  var t1, t2, t3, t4, t5, t6, t7, t8;
  t1 = new Q.Vector(null, null, null);
  t1._x = -20;
  t1._y = 0;
...
Isolate.$lazy($, "_keys", "KeyManager__keys", "get$KeyManager__keys", function() {
  return P.HashSet_HashSet(null, null, null, P.$int);
});
Isolate.$lazy($, "_circlePathCoordinates", "Path__circlePathCoordinates", "get$Path__circlePathCoordinates", function() {
  ...
  t8._y = 537;
  t8._z = 0;
  t9 = new Q.Vector(null, null, null);
  t9._x = 175;
  t9._y = 532;
  t9._z = 0;
  t10 = new Q.Vector(null, null, null);
  t10._x = 84;
  t10._y = 386;
  t10._z = 0;
  t11 = new Q.Vector(null, null, null);
  t11._x = 70;
  t11._y = 201;
  t11._z = 0;
  return [t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11];
});
Isolate.$lazy($, "_circlePath", "Path__circlePath", "get$Path__circlePath", function() {
  var t1, t2;
  t1 = new Q.Path(8, null, null);
  t1._coords = $.get$Path__circlePathCoordinates();
  t2 = new Q.Vector(null, null, null);
  t2._x = 0;
  t2._y = 0;
  t2._z = 0;
...
Isolate.$lazy($, "_diag1PathCoordinates", "Path__diag1PathCoordinates", "get$Path__diag1PathCoordinates", function() {
...
Isolate.$lazy($, "_diag1Path", "Path__diag1Path", "get$Path__diag1Path", function() {
  var t1, t2;
  t1 = new Q.Path(8, null, null);
  t1._coords = $.get$Path__diag1PathCoordinates();
  t2 = new Q.Vector(null, null, null);
  t2._x = 0;
  t2._y = 0;
  t2._z = 0;
...
Isolate.$lazy($, "_diag2PathCoordinates", "Path__diag2PathCoordinates", "get$Path__diag2PathCoordinates", function() {
  var t1, t2, t3, t4, t5, t6, t7;
  t1 = new Q.Vector(null, null, null);
  t1._x = 117;
  t1._y = 94;
...
Isolate.$lazy($, "_diag2Path", "Path__diag2Path", "get$Path__diag2Path", function() {
  var t1, t2;
  t1 = new Q.Path(8, null, null);
  t1._coords = $.get$Path__diag2PathCoordinates();
  t2 = new Q.Vector(null, null, null);
  t2._x = 0;
  t2._y = 0;
  t2._z = 0;
...
Isolate.$lazy($, "_diag3PathCoordinates", "Path__diag3PathCoordinates", "get$Path__diag3PathCoordinates", function() {
  var t1, t2, t3, t4, t5;
  t1 = new Q.Vector(null, null, null);
  t1._x = 322;
  t1._y = 195;
...
Isolate.$lazy($, "_diag3Path", "Path__diag3Path", "get$Path__diag3Path", function() {
  var t1, t2;
  t1 = new Q.Path(8, null, null);
  t1._coords = $.get$Path__diag3PathCoordinates();
  t2 = new Q.Vector(null, null, null);
  t2._x = 0;
  t2._y = 0;
  t2._z = 0;
...
Isolate.$lazy($, "paths", "Path_paths", "get$Path_paths", function() {
  return [$.get$Path__circlePath(), $.get$Path__diag1Path(), $.get$Path__diag2Path(), $.get$Path__diag3Path()];
});
// Native classes
...
//# sourceMappingURL=Launcher.dart.js.map
{
  var message =
...
function dart_precompiled($collectedClasses) {
  ...
  function TimerImpl(__isolate_helper$_once, _inEventLoop, _handle) {
    this.__isolate_helper$_once = __isolate_helper$_once;
  ...
  function Bomb(_ld31_bomb$_timer, _blowTime, _ld31_bomb$_x, _ld31_bomb$_y, _anim, _animIncrement, _ld31_bomb$_width, _ld31_bomb$_height, _radius, _blown, _done) {
    this._ld31_bomb$_timer = _ld31_bomb$_timer;
    this._blowTime = _blowTime;
    this._ld31_bomb$_x = _ld31_bomb$_x;
    this._ld31_bomb$_y = _ld31_bomb$_y;
    this._anim = _anim;
    this._animIncrement = _animIncrement;
    this._ld31_bomb$_width = _ld31_bomb$_width;
    this._ld31_bomb$_height = _ld31_bomb$_height;
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Bomb.prototype = $desc;
  function Bullet(_ld31_bullet$_width, _ld31_bullet$_height, _ld31_bullet$_x, _ld31_bullet$_y, _ld31_bullet$_xSpeed, _ld31_bullet$_ySpeed, _ld31_bullet$_isFromPlayer) {
    this._ld31_bullet$_width = _ld31_bullet$_width;
    this._ld31_bullet$_height = _ld31_bullet$_height;
    this._ld31_bullet$_x = _ld31_bullet$_x;
    this._ld31_bullet$_y = _ld31_bullet$_y;
    this._ld31_bullet$_xSpeed = _ld31_bullet$_xSpeed;
    this._ld31_bullet$_ySpeed = _ld31_bullet$_ySpeed;
    this._ld31_bullet$_isFromPlayer = _ld31_bullet$_isFromPlayer;
  }
  ...
  function Enemy(_ld31_enemy$_moveSpeed, _ld31_enemy$_maxSpeed, _ld31_enemy$_friction, _ld31_enemy$_x, _ld31_enemy$_y, _ld31_enemy$_width, _ld31_enemy$_height, _ld31_enemy$_xSpeed, _ld31_enemy$_ySpeed, _type, _ld31_enemy$_wave, _mainColor, _ld31_enemy$_health, _minAccuracy, _maxAccuracy, _ld31_enemy$_player, _ld31_enemy$_gun, _ld31_enemy$_timer, _waitTime, _ld31_enemy$_toIndex, _ld31_enemy$_pathVector, _ld31_enemy$_path, _ld31_enemy$_bounds) {
    this._ld31_enemy$_moveSpeed = _ld31_enemy$_moveSpeed;
    this._ld31_enemy$_maxSpeed = _ld31_enemy$_maxSpeed;
    this._ld31_enemy$_friction = _ld31_enemy$_friction;
    this._ld31_enemy$_x = _ld31_enemy$_x;
    this._ld31_enemy$_y = _ld31_enemy$_y;
    this._ld31_enemy$_width = _ld31_enemy$_width;
    this._ld31_enemy$_height = _ld31_enemy$_height;
    this._ld31_enemy$_xSpeed = _ld31_enemy$_xSpeed;
    this._ld31_enemy$_ySpeed = _ld31_enemy$_ySpeed;
    this._type = _type;
    this._ld31_enemy$_wave = _ld31_enemy$_wave;
    this._mainColor = _mainColor;
    this._ld31_enemy$_health = _ld31_enemy$_health;
    this._minAccuracy = _minAccuracy;
    this._maxAccuracy = _maxAccuracy;
    this._ld31_enemy$_player = _ld31_enemy$_player;
    this._ld31_enemy$_gun = _ld31_enemy$_gun;
    this._ld31_enemy$_timer = _ld31_enemy$_timer;
    this._waitTime = _waitTime;
    this._ld31_enemy$_toIndex = _ld31_enemy$_toIndex;
    this._ld31_enemy$_pathVector = _ld31_enemy$_pathVector;
    this._ld31_enemy$_path = _ld31_enemy$_path;
    this._ld31_enemy$_bounds = _ld31_enemy$_bounds;
  }
  ...
  function Player(_ld31_entity_player$_health, _ld31_entity_player$_maxHealth, _width, _height, _ld31_entity_player$_x, _ld31_entity_player$_y, _xSpeed, _ySpeed, _moveSpeed, _ld31_entity_player$_maxSpeed, _friction, _ld31_entity_player$_type, _ld31_entity_player$_hud, _bombTimer, trail, _gun, bounds) {
    this._ld31_entity_player$_health = _ld31_entity_player$_health;
    this._ld31_entity_player$_maxHealth = _ld31_entity_player$_maxHealth;
    this._width = _width;
    this._height = _height;
    this._ld31_entity_player$_x = _ld31_entity_player$_x;
    this._ld31_entity_player$_y = _ld31_entity_player$_y;
    this._xSpeed = _xSpeed;
    this._ySpeed = _ySpeed;
    this._moveSpeed = _moveSpeed;
    this._ld31_entity_player$_maxSpeed = _ld31_entity_player$_maxSpeed;
    this._friction = _friction;
    this._ld31_entity_player$_type = _ld31_entity_player$_type;
    this._ld31_entity_player$_hud = _ld31_entity_player$_hud;
    this._bombTimer = _bombTimer;
    this.trail = trail;
    this._gun = _gun;
    this.bounds = bounds;
  }
  ...
  function Game(_lastTimestamp, _canvas, g, _hud) {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game.prototype = $desc;
  function Gun(_fireDelay, _ld31_gun$_timer, _canFire, _isFromPlayer) {
    this._fireDelay = _fireDelay;
    this._ld31_gun$_timer = _ld31_gun$_timer;
    this._canFire = _canFire;
    this._isFromPlayer = _isFromPlayer;
  }
  Gun.builtin$cls = "Gun";
  if (!"name" in Gun)
    Gun.name = "Gun";
  $desc = $collectedClasses.Gun;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Gun.prototype = $desc;
  function HUD(_health, _maxHealth, _wave, _bombs, _ld31_hud$_canvas, g2) {
    this._health = _health;
    this._maxHealth = _maxHealth;
    this._wave = _wave;
    this._bombs = _bombs;
    this._ld31_hud$_canvas = _ld31_hud$_canvas;
    this.g2 = g2;
  }
  HUD.builtin$cls = "HUD";
  if (!"name" in HUD)
    HUD.name = "HUD";
  $desc = $collectedClasses.HUD;
  if ($desc instanceof Array)
    $desc = $desc[1];
  HUD.prototype = $desc;
  function KeyManager() {
  }
  KeyManager.builtin$cls = "KeyManager";
  if (!"name" in KeyManager)
    KeyManager.name = "KeyManager";
  $desc = $collectedClasses.KeyManager;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyManager.prototype = $desc;
  function KeyManager_closure() {
  }
  KeyManager_closure.builtin$cls = "KeyManager_closure";
  if (!"name" in KeyManager_closure)
    KeyManager_closure.name = "KeyManager_closure";
  $desc = $collectedClasses.KeyManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyManager_closure.prototype = $desc;
  function KeyManager_closure0() {
  }
  KeyManager_closure0.builtin$cls = "KeyManager_closure0";
  if (!"name" in KeyManager_closure0)
    KeyManager_closure0.name = "KeyManager_closure0";
  $desc = $collectedClasses.KeyManager_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  KeyManager_closure0.prototype = $desc;
  function MouseManager(_ld31_mouse$_xo, _ld31_mouse$_yo) {
    this._ld31_mouse$_xo = _ld31_mouse$_xo;
    this._ld31_mouse$_yo = _ld31_mouse$_yo;
  }
  ...
  function MouseManager_closure(this_0) {
    this.this_0 = this_0;
  }
  MouseManager_closure.builtin$cls = "MouseManager_closure";
  if (!"name" in MouseManager_closure)
    MouseManager_closure.name = "MouseManager_closure";
  $desc = $collectedClasses.MouseManager_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MouseManager_closure.prototype = $desc;
  function MouseManager_closure0() {
  }
  MouseManager_closure0.builtin$cls = "MouseManager_closure0";
  if (!"name" in MouseManager_closure0)
    MouseManager_closure0.name = "MouseManager_closure0";
  $desc = $collectedClasses.MouseManager_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MouseManager_closure0.prototype = $desc;
  function MouseManager_closure1() {
  }
  MouseManager_closure1.builtin$cls = "MouseManager_closure1";
  if (!"name" in MouseManager_closure1)
    MouseManager_closure1.name = "MouseManager_closure1";
  $desc = $collectedClasses.MouseManager_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MouseManager_closure1.prototype = $desc;
  function Particle(_ld31_particle$_x, _ld31_particle$_y, _ld31_particle$_xSpeed, _ld31_particle$_ySpeed, _life, _ld31_particle$_timer, _ld31_particle$_style) {
    this._ld31_particle$_x = _ld31_particle$_x;
    this._ld31_particle$_y = _ld31_particle$_y;
    this._ld31_particle$_xSpeed = _ld31_particle$_xSpeed;
    this._ld31_particle$_ySpeed = _ld31_particle$_ySpeed;
    this._life = _life;
    this._ld31_particle$_timer = _ld31_particle$_timer;
    this._ld31_particle$_style = _ld31_particle$_style;
  }
  ...
  function ParticleEmitter(_particles, _toRemove, _ld31_particleEmitter$_x, _ld31_particleEmitter$_y, _style, _amount, _generated, _removed, _particleWidth, _particleHeight, _minSpeed, _maxSpeed, _minAngle, _maxAngle, _minLife, _maxLife, _stableLife) {
    this._particles = _particles;
    this._toRemove = _toRemove;
    this._ld31_particleEmitter$_x = _ld31_particleEmitter$_x;
    this._ld31_particleEmitter$_y = _ld31_particleEmitter$_y;
    this._style = _style;
    this._amount = _amount;
    this._generated = _generated;
    this._removed = _removed;
    this._particleWidth = _particleWidth;
    this._particleHeight = _particleHeight;
    this._minSpeed = _minSpeed;
    this._maxSpeed = _maxSpeed;
    this._minAngle = _minAngle;
    this._maxAngle = _maxAngle;
    this._minLife = _minLife;
    this._maxLife = _maxLife;
    this._stableLife = _stableLife;
  }
  ...
  function Path(_threshhold, _coords, _resultVector) {
    this._threshhold = _threshhold;
    this._coords = _coords;
    this._resultVector = _resultVector;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Path.prototype = $desc;
  function PlayerModule(_ld31_player_module$_player, _ld31_player_module$_health, _ld31_player_module$_width, _ld31_player_module$_height, _ld31_player_module$_x, _ld31_player_module$_y, _ld31_player_module$_xSpeed, _ld31_player_module$_ySpeed, _ld31_player_module$_moveSpeed, _ld31_player_module$_maxSpeed, _ld31_player_module$_friction, _xo, _yo, _ld31_player_module$_gun, _bounds, _isAttached, _toIndex, _path, _pathVector) {
    this._ld31_player_module$_player = _ld31_player_module$_player;
    this._ld31_player_module$_health = _ld31_player_module$_health;
    this._ld31_player_module$_width = _ld31_player_module$_width;
    this._ld31_player_module$_height = _ld31_player_module$_height;
    this._ld31_player_module$_x = _ld31_player_module$_x;
    this._ld31_player_module$_y = _ld31_player_module$_y;
    this._ld31_player_module$_xSpeed = _ld31_player_module$_xSpeed;
    this._ld31_player_module$_ySpeed = _ld31_player_module$_ySpeed;
    this._ld31_player_module$_moveSpeed = _ld31_player_module$_moveSpeed;
    this._ld31_player_module$_maxSpeed = _ld31_player_module$_maxSpeed;
    this._ld31_player_module$_friction = _ld31_player_module$_friction;
    this._xo = _xo;
    this._yo = _yo;
    this._ld31_player_module$_gun = _ld31_player_module$_gun;
    this._bounds = _bounds;
    this._isAttached = _isAttached;
    this._toIndex = _toIndex;
    this._path = _path;
    this._pathVector = _pathVector;
  }
  PlayerModule.builtin$cls = "PlayerModule";
  if (!"name" in PlayerModule)
    PlayerModule.name = "PlayerModule";
  $desc = $collectedClasses.PlayerModule;
  if ($desc instanceof Array)
    $desc = $desc[1];
  PlayerModule.prototype = $desc;
  function State() {
  }
  ...
  function DeathState(_playBounds, _hover, _timer) {
    this._playBounds = _playBounds;
    this._hover = _hover;
    this._timer = _timer;
  }
  DeathState.builtin$cls = "DeathState";
  if (!"name" in DeathState)
    DeathState.name = "DeathState";
  $desc = $collectedClasses.DeathState;
  if ($desc instanceof Array)
    $desc = $desc[1];
  DeathState.prototype = $desc;
  function GameState(_waveManager, _player, _ld31_state_game$_hud) {
    this._waveManager = _waveManager;
    this._player = _player;
    this._ld31_state_game$_hud = _ld31_state_game$_hud;
  }
  ...
  function MenuState(_emitters, _ld31_state_menu$_hover, _before, _ld31_state_menu$_playBounds, _ld31_state_menu$_timer) {
    this._emitters = _emitters;
    this._ld31_state_menu$_hover = _ld31_state_menu$_hover;
    this._before = _before;
    this._ld31_state_menu$_playBounds = _ld31_state_menu$_playBounds;
    this._ld31_state_menu$_timer = _ld31_state_menu$_timer;
  }
